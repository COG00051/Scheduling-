...
export class FlotComponent implements OnInit {
  ...
  ngOnInit() {
      ...
      $(function() {
          ...
          const trackingPlot = $.plot('#tracking_chart', trackingData, {
              crosshair: {
                  mode: 'x'
              },
              grid: {
          ...
          const legends = $('#tracking_chart .legendLabel');
          ...
          function updateLegend() {
              ...
              const axes = trackingPlot.getAxes();
              ...
              let i, j;
              const dataset = trackingPlot.getData();
          ...
          $(function() {
              ...
              for (let i = 0; i <= 10; i += 1) {
                  d1.push([i, parseInt( (Math.random() * 60).toString() )]);
              }
              const d2 = [];
              for (let i = 0; i <= 10; i += 1) {
                  d2.push([i, parseInt( (Math.random() * 40).toString() )]);
              }
              const d3 = [];
              for (let i = 0; i <= 10; i += 1) {
                  d3.push([i, parseInt( (Math.random() * 25).toString() )]);
              }
          ...
          const barChartData = [];
          for (let i = 0; i <= 10; i += 1) {
              barChartData.push([i, parseInt( (Math.random() * 30).toString() )]);
          }
          ...
          const pieChartData = [],
              pieChartSeries = 4;
          const pieChartColors = ['#f8a427', '#ef5c64', '#2d9fd1', '#60c7aa'];
          const pieChartDatas = [45, 17, 28, 10];

          for (let i = 0; i < pieChartSeries; i++) {
              pieChartData[i] = {
                  label: 'Serie - ' + (i + 1),
          ...
          function labelFormatter(label, series) {
              let result = '<div style="font-size:8pt; text-align:center; padding:2px; color:white;">' + label + '<br/>';
              result += Math.round(series.percent) + '%</div>';
              return result;
          }
      // ====================================================================================================
      });
