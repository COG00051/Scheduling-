...
export class GoogleComponent implements OnInit {
  ...
  ngOnInit() {
      ...
      // Static maps
      const staticMap = GMaps.staticMapURL({
      ...
      const staticMapWithMarkers = GMaps.staticMapURL({
      ...
      const staticMapPolyline = GMaps.staticMapURL({
      ...
      // Panorama
      const panorama = GMaps.createPanorama({
          el: '#gmap_panorama',
          lat: 42.3455,
          lng: -71.0983
      });
